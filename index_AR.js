document.addEventListener("DOMContentLoaded", function() {
    document.getElementById("topButton").addEventListener("click", function() {
        ...
        if (localStorage.getItem("arpage") === "ar") {
            ...
            document.querySelector("h1").innerHTML = arabicH2;
            document.querySelector("h1").classList.add("arabic"); // Add Arabic class
            
            // Replace the application entry link with Arabic
            const arabicLink = "<b>ادخل التطبيق من هنا</b>";
            document.querySelector("a[href='https://engineerr1983.github.io/hello-world-page/loginscreen.html'] h2").innerHTML = arabicLink;
            document.querySelector("a[href='https://engineerr1983.github.io/hello-world-page/loginscreen.html'] h2").classList.add("arabic"); // Add Arabic class
            ...
            document.querySelectorAll("h3")[1].innerHTML = arabicH4;
            document.querySelectorAll("h3")[1].classList.add("arabic"); // Add Arabic class
        }
    });
});
